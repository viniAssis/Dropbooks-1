            ...
            <div class="container">
                ...
                <div class="form-row">
                    <div class="col-md-8 mb-8">
                        ...
                        <input type="text" class="form-control border border-dark" name="nome" maxlength="100" id="nome">
                    </div>

                    <div class="col-md-4 mb-8">
                        <label>CPF:</label>
                        <input type="text" class="form-control border border-dark" name="cpf" id="cpf" required maxlength="11">
                    </div>
                </div>

                <!-- Data Nascimento e Sexo -->
                <div class="form-row" id="espaco1">
                    <div class="col-md-6 mb-8" >
                        <label>Sexo:</label>
                    ...
                    <div class="col-md-6 mb-8">
                        ...
                        <input type="date" class="form-control border border-dark " name="dataNascimento" id="data"  required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-8">
                        ...
                        <input type="tel" class="form-control border border-dark" name="telefone"  id="telefone" required maxlength="12">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-8">
                        <label>CEP:</label>
                        <input type="text" class="form-control border border-dark" name="cep" id="cep" required maxlength="8">
                    </div>
                    ...
                    <div class="col-md-6 mb-8">
                        ...
                        <input type="text" class="form-control border border-dark" name="end" maxlength="50" id="end" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3 mb-3">
                        <label>Digito:</label>
                        <input type="text" class="form-control border border-dark" name="dig" id="dig"  maxlength="2" required>
                    </div>
                </div>
