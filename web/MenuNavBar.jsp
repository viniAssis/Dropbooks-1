...
<body>
     <nav class="navbar fixed-top navbar-expand-lg navbar-dark  fixed-top" id="nav">
        <div class="container">
            <a class="navbar-brand a" href="index.jsp">DropBooks</a>
                        ...
                        <%
                            ...
                            if (session.getAttribute("email") != null) {
                                ...
                                if (user.getNivel_usuario().equals("1")) {
                                    ...
                                    out.print("<a class='dropdown-item' href='listaUsuarioFuncionario.jsp' id='link' >Lista de Funcionários</a>");
                                    out.print("<a class='dropdown-item' href='analytics.html' id='link'  >Analytics</a>");
                                    out.print("<a class='dropdown-item' href='alterarCarrossel.jsp' id='link' >Alterar Banner</a>"
                                ...
                                out.print("<a class='dropdown-item' href='carrinho.jsp' id='link'>Carrinho</a>"
                                        ...
                                        + "<a class='dropdown-item' href=Senha.jsp id='link' >Alterar Senha</a>"
                                        + "<a class='dropdown-item' name=Sair href=SairServlet>Sair</a>"
                                        + "</div>"
                                        + "</li>");
                                }
