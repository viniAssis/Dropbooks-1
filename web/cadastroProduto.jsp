            ...
            <div class="container1">
                <div  class="form-signin"> 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control  border border-dark" id="nameLivro" name="nameLivro"  maxlength="70" required>
                    </div>   

                    <!-- Titulo do livro -->
                    <div class="form-group">
                        <label id="texto">Autor</label>
                        <input type="text" class="form-control  border border-dark" id="nameAutor" maxlength="70"  name="nameAutor" required>
                    </div>

                    <!--Editora -->
                    <div class="form-group">
                        <label id="texto">Editora</label>
                        <input type="text" class="form-control  border border-dark" id="nameEditora" maxlength="70" name="nameEditora" required>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="date" class="form-control  border border-dark" id="anoLancamento" maxlength="4" name="anoLancamento" required>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control  border border-dark" id="descricao" name="descricao" placeholder="Descrição do produto" maxlength="2000" rows="3"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="container2">
                <div class="form-signin">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control  border border-dark" id="idiomaLivro" maxlength="45" name="idiomaLivro" required>
                    </div>

                    <!-- Quantidade -->
                    <div class="form-group">
                        <label id="texto">Quantidade</label>
                        <input type="text" class="form-control  border border-dark" id="qtdLivro" maxlength="3" name="qtdLivro" required>
                    </div>

                    <!-- Valor de cada Livro-->	
                    <div class="form-group">
                        <label id="texto">Valor do Livro</label>
                        <input type="text" class="form-control  border border-dark" id="valorLivro" maxlength="6" name="valorLivro" required>
                    </div>
